...
export const ANIME_LAYOUT_CONFIG = Object.freeze({
 ...
 */
export function effectiveAnimeLayout(width: number, preference: 'scene' | 'work'): 'scene' | 'work' {
  return width <= ANIME_LAYOUT_CONFIG.workLayoutMaxWidth ? 'work' : preference
}
