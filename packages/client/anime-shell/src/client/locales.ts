/** Simplified Chinese anime-shell messages. */
export const zh = {
  'mode.scene': '场景模式',
  'mode.work': '工作模式',
...
/** Translation keys owned by the anime shell. */
export type AnimeShellKey = keyof typeof zh

declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface LocaleNamespaceMap {
    'anime.shell': AnimeShellKey
  }
}

/** English anime-shell messages. */
export const en = {
  'mode.scene': 'Scene',
  'mode.work': 'Work',
  'title.app': 'DeepSeek Harness · Lumi',
...
} satisfies Record<AnimeShellKey, string>
