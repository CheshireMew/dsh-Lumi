...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  animeCharacter: 'client-side character presentation service — packages/client/anime-character/README.md owns the API',
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'message-feedback/change': 'client-face durable-rating acknowledgment — packages/client/ui-message-feedback/README.md owns the API',
