...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/anime-character': { kind: 'none', reason: 'Browser-side character presentation and Host-side local asset delivery register nothing model-facing.' },
  'packages/client/anime-shell': { kind: 'none', reason: 'Browser-side layout presentation registers nothing model-facing.' },
  ...
  'packages/bundle/anime-desktop': { kind: 'none', reason: 'The additive product bundle mounts only presentation, speech, and local progression rows that register nothing model-facing.' },
