...
The multi-runtime engine range and CI matrix below are superseded by [one Node 22 runtime and Lumi repository governance](2026-08-15-node-22-lumi-repository-governance.md). The measured Node 22 dependency floor remains the rationale for `^22.19.0`.
